...
let () =
  ...
  add_global_value
  { qualid=Lident "input_char"
  ; info={ v_typ=type_arrow type_unit type_char
         ; v_prim=Prim(1, Pccall(1, "input_char"))
         }
  };
  add_global_value
  { qualid=Lident "recv_char"
  ; info={ v_typ=type_arrow type_unit type_char
         ; v_prim=Prim(1, Pccall(1, "recv_char"))
         }
  };
  add_global_value
  ...
  add_global_value
  { qualid=Lident "send_string"
  ; info={ v_typ=type_arrow type_string type_unit
         ; v_prim=Prim(1, Pccall(1, "send_string"))
         }
  };
  add_global_value
  { qualid=Lident "not"
